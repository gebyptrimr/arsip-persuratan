...
function SuratTugas() {
  ...
  const filtered = dataSuratTugas.filter(
    (r) =>
      r.nomorST.toLowerCase().includes(query.toLowerCase()) ||
      r.penerimaTugas.toLowerCase().includes(query.toLowerCase()) ||
      r.tujuanTugas.toLowerCase().includes(query.toLowerCase()),
  );
    ...
    <div style={s.wrap}>
      ...
      <div style={s.card}>
        <div style={s.cardHead}>
          ...
          <span style={s.cntBadge}>{filtered.length} surat tugas</span>
          <div style={{ flex: 1 }} />
        </div>
        ...
        <div style={s.cardBody}>
          <div style={{ marginBottom: 16 }}>
            <input
              type="text"
              placeholder="Cari nomor surat tugas atau penerima tugas..."
              value={query}
          ...
          >
            <span style={{ fontSize: 11.5, color: "#888" }}>
              Menampilkan {filtered.length} dari {dataSuratTugas.length} surat
              tugas
            </span>
          </div>
        </div>
