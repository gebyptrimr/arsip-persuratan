...
function Kontrak() {
  ...
  const filtered = dataKontrak.filter(
    (r) =>
      r.nomorKontrak.toLowerCase().includes(query.toLowerCase()) ||
      r.judulKontrak.toLowerCase().includes(query.toLowerCase()) ||
      r.pihakPertama.toLowerCase().includes(query.toLowerCase()) ||
      r.pihakKedua.toLowerCase().includes(query.toLowerCase()),
  );
    ...
    <div style={s.wrap}>
      ...
      <div style={s.card}>
        <div style={s.cardHead}>
          ...
          <span style={s.cntBadge}>{filtered.length} kontrak</span>
          <div style={{ flex: 1 }} />
        </div>
        ...
        <div style={s.cardBody}>
          ...
          >
            <span style={{ fontSize: 11.5, color: "#888" }}>
              Menampilkan {filtered.length} dari {dataKontrak.length} kontrak
            </span>
          </div>
        </div>
      </div>
