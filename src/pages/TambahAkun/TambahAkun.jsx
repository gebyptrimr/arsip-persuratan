          ...
          <div className="ta-fields">
            ...
            <div className={`ta-group ${errors.password ? "has-error" : ""}`}>
              ...
              <div className="ta-input-wrap">
                ...
                <input type={showPassword ? "text" : "password"} name="password" placeholder="Minimal 8 karakter" value={form.password} onChange={handleChange} />
            ...
            <div className={`ta-group ${errors.konfirmasiPassword ? "has-error" : ""}`}>
              ...
              <div className="ta-input-wrap">
                ...
                <input type={showKonfirmasi ? "text" : "password"} name="konfirmasiPassword" placeholder="Ulangi password" value={form.konfirmasiPassword} onChange={handleChange} />
