...
function UploadPenelitianInternal() {
  const [jenis, setJenis] = useState("");
  const navigate = useNavigate();

  const handleLanjut = () => {
    if (jenis === "proposal")
      navigate("/kebijakan/proposal-pengabdian-inernal-tambah");
    else if (jenis === "sk") navigate("/kebijakan/sk-pengabdian-tambah");
    if (jenis === "kontrak") navigate("/kebijakan/kontrak-pengabdian-tambah");
    if (jenis === "laporan") navigate("/kebijakan/laporan-pengabdian-tambah");
  };
...
export default UploadPenelitianInternal;
