...
const jenisArsip = [
  ...
  {
    value: "buktiPublikasi",
    label: "Bukti Publikasi",
    icon: (
      <svg
        width="22"
        height="22"
...
function UploadPublikasi() {
  const [jenis, setJenis] = useState("");
  const navigate = useNavigate();

  const handleLanjut = () => {
    if (jenis === "skHki")
      navigate("/publikasi/sk-hki-tambah");
    else if (jenis === "sertifikatPaten") navigate("/publikasi/sertifikat-paten-tambah");
    if (jenis === "buktiPublikasi") navigate("/publikasi/bukti-publikasi-tambah");
  };
...
export default UploadPublikasi;
