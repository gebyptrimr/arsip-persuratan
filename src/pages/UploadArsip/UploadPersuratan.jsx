...
function UploadKepegawaian() {
  const [jenis, setJenis] = useState("");
  const navigate = useNavigate();

  const handleLanjut = () => {
    if (jenis === "suratMasuk") navigate("/kepegawaian/surat-masuk-tambah");
    else if (jenis === "suratKeluar")
      navigate("/kepegawaian/surat-keluar-tambah");
    if (jenis === "ba") navigate("/kepegawaian/ba-tambah");
  };
...
export default UploadKepegawaian;
