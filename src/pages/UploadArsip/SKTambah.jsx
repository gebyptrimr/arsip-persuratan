...
function SKTambah() {
  ...
  const handleSubmit = (e) => {
    ...
    Swal.fire({
      icon: "success",
      title: "Berhasil!",
      text: "Data SK berhasil disimpan.",
      ...
      <div style={s.card}>
        ...
        <div style={s.cardBody}>
          <form onSubmit={handleSubmit}>
            {/* ── Section: Identitas SK ── */}
            <div style={s.sectionBlock}>
              <div style={s.sectionHead}>
                <div style={s.sectionDot} />
                <span style={s.sectionLabel}>Identitas SK</span>
              </div>
              <div style={s.row}>
            ...
            <div style={s.sectionBlock}>
              <div style={s.sectionHead}>
                <div style={s.sectionDot} />
                <span style={s.sectionLabel}>Detail Penetapan</span>
              </div>
              <div style={s.row}>
                ...
                <Field label="Pejabat Penetap" half>
                  <div style={s.inputWrap}>
                    ...
                    <input
                      type="text"
                      style={s.input}
                      placeholder="Nama pejabat yang menetapkan"
                    />
                  </div>
                </Field>
              </div>
