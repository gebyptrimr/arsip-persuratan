...
function UploadPenelitianInternal() {
  ...
  const handleLanjut = () => {
    if (jenis === "mou") navigate("/kebijakan/mou-tambah");
    else if (jenis === "moa") navigate("/kebijakan/moa-tambah");
    if (jenis === "kontrak-kerjasama")
      navigate("/kebijakan/kontrak-kerjasama-tambah");
  };
