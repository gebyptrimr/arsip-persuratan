...
const jenisArsip = [
  {
    value: "proposal-pengabdian-eksternal",
    label: "Proposal",
    icon: (
      <svg
        width="22"
...
function UploadPengabdianEksternal() {
  const [jenis, setJenis] = useState("");
  const navigate = useNavigate();

  const handleLanjut = () => {
    if (jenis === "proposal-pengabdian-eksternal")
      navigate("/kebijakan/proposal-pengabdian-eksternal-tambah");
    else if (jenis === "kontrak-induk")
      navigate("/kebijakan/kontrak-induk-pengabdian-tambah");
    if (jenis === "kontrak-turunan")
      navigate("/kebijakan/kontrak-turunan-pengabdian-tambah");
    if (jenis === "laporan-kemajuan")
      navigate("/kebijakan/laporan-kemajuan-pengabdian-tambah");
    if (jenis === "laporan-akhir")
      navigate("/kebijakan/laporan-akhir-pengabdian-tambah");
  };
...
export default UploadPengabdianEksternal;
