...
function SuratKeluarTambah() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 1. Upload file PDF ke bucket surat-keluar
      const file = formData.file;
      const fileExt = file.name.split(".").pop();
      const uploadName = `${Date.now()}_${formData.nomorSurat.replace(/\//g, "-")}.${fileExt}`;
      ...
      // 3. Simpan ke tabel surat_keluar
      ...
      <div style={s.card}>
        ...
        <div style={s.cardHead}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div style={s.cardTitle}>Tambah Surat Keluar</div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={s.sectionBlock}>
              <div style={s.sectionHead}>
                ...
                <span style={s.sectionLabel}>Identitas Surat Keluar</span>
              </div>
              <div style={s.row}>
            ...
            <div style={s.actionBar}>
              <SipasButton type="button" baseStyle={s.btnBatal} onClick={() => navigate("/surat-keluar")}>
...
const s = {
  ...
  card: { backgroundColor: "#fff", borderRadius: 14, overflow: "hidden", border: "0.5px solid #e0e0e0" },
  ...
  input: { width: "100%", padding: "9px 12px", border: "0.5px solid #D1D5DB", borderRadius: 8, fontSize: 13, outline: "none", backgroundColor: "#FAFAFA", color: "#1A1A1A", boxSizing: "border-box", transition: "border .15s" },
...
export default SuratKeluarTambah;