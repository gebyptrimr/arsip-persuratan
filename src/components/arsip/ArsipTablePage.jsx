    ...
    <div style={m.overlay}>
      <div style={m.card}>
        ...
        <div style={m.body}>
          ...
          >
            Nomor berkas tidak dapat diubah di sini. Jika nomor salah, hapus
            data ini lalu unggah ulang.
          </div>
...
export default function ArsipTablePage({ configKey }) {
  ...
  const kondisiBadgeStyle = (kondisi) => {
    const map = {
      Baik: ["#F0FFF4", "#166534"],
      "Rusak Ringan": ["#FFF7E6", "#8A5A00"],
      "Rusak Berat": ["#FCEBEB", "#791F1F"],
    };
  ...
  if (!config) {
    return (
      <div style={{ padding: 24, color: "#DC2626" }}>
        Config "{configKey}" tidak ditemukan di arsipConfig.js
      </div>
    );
  }
